...
In this example, we cover a simple use case that the Intersight Platform and Terrraform Cloud Business Tier to deploy virtual machines on-premise. This use case w1ill walk the user through the following steps.
...
1. Intersight SaaS platform account
...
2. Go to the Variables section and add the following variables with the value specific to your environment
